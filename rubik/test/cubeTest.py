...
#        none
    ...
    def test_rotate_150_ShouldRotateCubeInDDirection(self):
        cubeToRotate = '9aAa00ZAaz9aA9zZzaZ000aA990zZ0zAzZ09AZAAzazZa0a99Z9AZz'
        theCube = cube.Cube(cubeToRotate)
        rotatedCube = theCube.rotate("D")
        expectedCube = '9aAa00Z09z9aA9zZAaZ000aAZzazZ0zAz990AZAAzazZaA90ZZaz99'
        self.assertEqual(rotatedCube, expectedCube)

    def test_rotate_160_ShouldRotateCubeIndDirection(self):
        cubeToRotate = '9aAa00ZAaz9aA9zZzaZ000aA990zZ0zAzZ09AZAAzazZa0a99Z9AZz'
        theCube = cube.Cube(cubeToRotate)
        rotatedCube = theCube.rotate("d")
        expectedCube = '9aAa00Zzaz9aA9z990Z000aAZ09zZ0zAzZAaAZAAzazZa99zaZZ09A'
        self.assertEqual(rotatedCube, expectedCube)
